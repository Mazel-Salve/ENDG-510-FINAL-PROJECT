...
from tkinter import filedialog # https://stackoverflow.com/questions/53197288/i-keep-getting-an-error-when-i-try-to-import-tkfiledialog
from math import log


filename = filedialog.askopenfilename(title="Select a log:", initialdir="./", filetypes = [("Log files","*.csv"),("All", "*")])

cr = csv.reader(open(filename,"rt")) # https://stackoverflow.com/questions/8515053/csv-error-iterator-should-return-strings-not-bytes
